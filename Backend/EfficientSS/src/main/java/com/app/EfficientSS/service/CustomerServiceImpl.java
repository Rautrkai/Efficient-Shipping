...
public class CustomerServiceImpl implements CustomerService {
	...
	public ResponseEntity<String> CustomerRegistration(Customer customer) {
		...
		public Customer validateCustomer(Customer cust) {
			...
			if(cust.getCust_email_id().equals(customer.getCust_email_id()) && cust.getCust_password().equals(customer.getCust_password()) && cust.getCust_blacklist().equalsIgnoreCase("Clear"))
			return customer;
			else 
				return null;
		}
