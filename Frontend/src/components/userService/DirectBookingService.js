...
const EMPLOYEE_API_BASE_URL = "http://localhost:8282/customer/transporter";

const API = "http://localhost:8282/transporter/estimatedprice";

const ITEM_LIST_API = "http://localhost:8282/customer/itemdetails";
...
const API8 = "http://localhost:8282/admin/feedback";

const API9 = "http://localhost:8282/transporter/payment";

const API10 = "http://localhost:8282/admin/payment";

const API11 = "http://localhost:8282/admin/customer";

const API12 = "http://localhost:8282/transporter/selectedBidders";
 ...
 class DirectBookingService {
   ...
   getfeedback()
   {
    ...
    const feedback = axios.get("http://localhost:8282/admin/feedback");
